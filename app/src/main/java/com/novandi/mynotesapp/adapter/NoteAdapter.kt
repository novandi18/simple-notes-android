package com.novandi.mynotesapp.adapter

import android.view.LayoutInflater
import android.view.View
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.novandi.mynotesapp.R
import com.novandi.mynotesapp.databinding.ItemNoteBinding
...
class NoteAdapter(private val onItemClickCallback: OnItemClickCallback) : RecyclerView.Adapter<NoteAdapter.NoteViewHolder>() {
    ...
    override fun onBindViewHolder(holder: NoteAdapter.NoteViewHolder, position: Int) = holder.bind(listNotes[position])
